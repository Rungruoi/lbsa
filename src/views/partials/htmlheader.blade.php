...
<title> DRVN - TIS | Tổng cục đường bộ Việt Nam - Hệ thống quản lý công nghệ </title>
...
<link rel="apple-touch-startup-image" href="/sa/img/splash/ipad-landscape.png" media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
